  ...
  return (
    <View style={css.container}>
      ...
      <TouchableOpacity style={css.btnVoltar}>
          <Text style={css.voltar} onPress={() => setDiario(null)}>˂</Text>
      </TouchableOpacity>
      </View>
      ...
      <View>
        <Text style={css.text}>Pause e desabafe. Este é um espaço confortavável para registrar suas emoções diárias. 
        </Text>
      </View>
      <View style={css.escrever}>
      </View>
